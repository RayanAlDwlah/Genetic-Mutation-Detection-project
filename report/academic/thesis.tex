...
\begin{tikzpicture}[
  ...
  % Package labels
  \node[font=\sffamily\footnotesize\bfseries, blue!60!black, above=0.15cm of load] {\texttt{src/data/}};
  \node[font=\sffamily\footnotesize\bfseries, green!50!black, above=0.15cm of xgb] {\texttt{src/models/}};
  \node[font=\sffamily\footnotesize\bfseries, orange!70!black, above=0.15cm of shap] {\texttt{src/eval/}};
  \node[font=\sffamily\footnotesize\bfseries, red!60!black, above=0.15cm of web] {\texttt{src/interfaces/}};
...
\begin{tikzpicture}[
  ...
  % Fork 1 --- leakage gate (4 parallel checks)
  \node[fork, below=0.45cm of load] (f1) {};
  \node[act, below=0.55cm of f1, xshift=-4.2cm] (ch1) {Check banned features};
  \node[act, below=0.55cm of f1, xshift=-1.4cm] (ch2) {Check 100\% missense};
  \node[act, below=0.55cm of f1, xshift=1.4cm]  (ch3) {Check no paralog};
  \node[act, below=0.55cm of f1, xshift=4.2cm]  (ch4) {Check rate gap};
...
Baselines vs ours (clinvar_test slice):
  ...
  XGBoost (ours) ROC 0.938 [0.935, 0.941]   PR 0.838
