...
full-training-set ESM-2 scoring runs on a free Google
Colab T4 session for approximately eight hours, with
checkpoints written to a Drive-mounted cache every $500$
variants. Because the run is GPU-bound and external to the
local repository, it is reported in the CHANGELOG rather
than reproduced inline here.
