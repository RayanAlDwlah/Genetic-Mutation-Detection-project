...
\begin{frame}{What we contribute}
  \begin{enumerate}
    ...
    \item \textbf{Fully reproducible code base}: $141$ tests
          ($91\%$ coverage), CI-enforced leakage gate, pinned
...
\begin{frame}{Hardware + software stack}
  \begin{columns}[t]
    ...
    \begin{itemize}
      ...
      \item 141 pytest tests, 91\% coverage
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.43\linewidth}
      ...
      \begin{tabular}{@{}lr@{}}
        ...
        \midrule
        Total tests   & 141 / 142 pass \\
        Coverage      & 91\% \\
        Critical modules & $\geq$92\% \\
...
% ───────────── SLIDE 29 ─────────────
\begin{frame}{Continuous integration: 141 tests on every push}
  \centering
